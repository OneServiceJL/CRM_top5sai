...
<div class="navbar-right">
    <ul class="navbar-nav">
        ...
        <!-- Chat -->
        <li class="dropdown">
            <a href="javascript:void(0);" class="dropdown-toggle" title="Chat" data-toggle="dropdown"
                role="button"><i class="zmdi zmdi-comments"></i></a>
            <ul class="dropdown-menu slideUp2">
                <li class="header">Chat</li>
                <li class="body">
                    <ul class="menu chat_list list-unstyled">
                        <li>
                            <a href="javascript:void(0);">
                        ...
                        <li>
                            <a href="javascript:void(0);">
                                <div class="icon-circle mb-2 bg-amber"><i class="zmdi zmdi-account"></i></div>
                        ...
                        <li>
                            <a href="javascript:void(0);">
                                <div class="icon-circle mb-2 bg-purple"><i class="zmdi zmdi-account"></i></div>
                                <p class="mb-0">Emily Davis</p>
